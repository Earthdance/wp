...
function scripts_n_styles() {
    ...
    wp_register_script('modernizr', get_template_directory_uri().'/js/vendor/modernizr.js' );
		...
		wp_register_script('headroom', get_template_directory_uri().'/js/vendor/headroom.js', array( 'jquery' ),'0.1',true);
		...
		wp_register_script('script', get_template_directory_uri().'/js/script.js', array( 'jquery' ),'0.1', true );
