...
<div class="header__layer">
  <div class="header__container">
    <div class="header__item">
			<a href="x" class="header__logo">EarthDance
      <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 148.7 149.4">
    ...
    <div class="header__item">
			<a href="x" class="header__link">233 Dade Ave. Ferguson</a>
			<a href="x" class="header__link">314-521-1006</a>
			<a href="x" class="header__link">fb</a>
			<a href="x"class="header__link">tw</a>
			<a href="x" class="header__link">yt</a>
		</div>
  </div>
</div>
...
<div class="feature__layer">
  <div class="feature__container">
    <div class="feature__nav">
			<a href="x" class="feature__link">About</a>
			<a href="x" class="feature__link">Food</a>
			<a href="x" class="feature__link">Farmers</a>
			<a href="x" class="feature__link">Community</a>
			<a href="x" class="feature__link">Support</a>
			<a href="x" class="feature__link">News</a>
			<a href="x" class="feature__link">Jobs</a>
			<a href="x" class="feature__link">Contact</a>
		</div>
    <div class="feature__main">
      ...
      <h1 class="feature__title">EarthDance</h1>
  ...
  <div class="grow__container">
    ...
    <div class="grow__columns zipper">
      ...
      <div class="grow__content">
        ...
        <a href="x" class="grow__button">read more</a>
      </div>
    </div>
...
<div class="believe__layer">
  <div class="believe__container">
    ...
    <div class="believe__photo">
			<img src="x" class="believe__image"/>
			<a href="x" class="believe__button">check us out</a>
		</div>
    ...
    <div class="believe__options">
			<a href="x" class="believe__button">Donate</a>
			<a href="x" class="believe__button">Volunteer</a>
		</div>
  </div>
</div>
