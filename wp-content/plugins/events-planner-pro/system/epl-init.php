...
class EPL_Init {
    ...
    function reorder_menu() {
        global $submenu;
        if ( !epl_user_is_admin() || epl_get_setting( 'epl_event_options', 'epl_admin_event_list_version', 2 ) == 1 )
            return false;
    ...
    function common_js_files() {
        ...
        $epl_wp_localize_script_args = apply_filters( 'epl_wp_localize_script_args', $wp_localize_script_args );
        wp_localize_script( 'events_planner_js', 'EPL', $wp_localize_script_args );
    ...
    function load_datepicker_files() {
        ...
        wp_enqueue_style( 'events-planner-jquery-ui-style', (is_ssl() ? 'https' : 'http' ) . '://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/smoothness/jquery-ui.css' );
    ...
    function load_front_stylesheets() {
        ...
        if ( $theme != '' )
            wp_enqueue_style( 'fullcalendar-jquery-ui-style', epl_get_protocol() . '://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/' . $theme . '/jquery-ui.css' );
