...
<div id="" class="class_list" style="margin:3; border: 1px solid #ddd;padding: 20px;min-height: 200px;overflow: hidden;">
...
<div id="sign_in_name_section" class="dataTables_wrapper" style="margin:20px 0; border: 1px solid #ddd;padding: 5px 10px;">
