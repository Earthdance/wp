...
<script type="text/javascript" charset="utf-8">
    ...
    jQuery(document).ready(function($) {
        ...
        $('.events-filters').prepend('<div class=\"dataTables_filter\"><label class=\"column-label\">Dates from:</label><input id=\"datepicker_min\" class=\"filter-date\"type=\"text\"><label>to</label><input id=\"datepicker_max\" class=\"filter-date\"type=\"text\"><p class=\"column-label\">Sort By:</p><a id=\"sorter1\" href=\"javascript:void(0);\">Date</a><a id=\"sorter7\" href=\"javascript:void(0);\">Title</a></div>');
...
<style type="text/css" media="all">
    ...
    .dataTables_wrapper .dataTables_length, .dataTables_wrapper .dataTables_info { float: left; clear: none; width: auto; line-height: 20px; margin-right: 10px; margin-top: 20px; }
    ...
    .info_row .dataTables_filter input                  { background: #333; }

    .info_row .DTTT_container                           { margin-bottom: 0; }
    .info_row .DTTT_container a.DTTT_button             { background: none; box-shadow: none; color: #fff !important; font-size: 12px; border: 0; text-decoration: underline !important; padding: 5p 5px; margin-right: 3px; }
    ...
    .info_row .dataTables_info, .info_row .dataTables_paginate      { margin-top: 5px; padding-top: 0; }
    .info_row .dataTables_paginate a                                { background: none; color: #21759B; font-weight: normal; padding: 0 5px; text-decoration: underline; border: 0; }
            ...
            while ( $event_list->have_posts() ) :
                ...
                foreach ( $event_details['_epl_start_date'] as $date_id => $date ):
                    ...
                    foreach ( $event_details['_epl_start_time'] as $time_id => $time ) {
                        ...
                        $delete_link = epl_anchor( get_delete_post_link(), '<img src="' . EPL_FULL_URL . '/images/delete.png" class="epl_fr" />', '_self' );
                        ...
                        if ( $no_date ) {
                            ...
                            $temp_table_row .= '<td></td>';
                            $temp_table_row .= '<td class="title">' . $event_edit_link . $formatted_status . '</td>';
                            $temp_table_row .= '<td></td>';
                            $temp_table_row .= '<td></td>';
                            $temp_table_row .= '<td></td>';
...
<table id="" class="setup_dataTable wp-list-table widefat fixed posts" style="min-width:1100px;">
		<thead>
    		<tr role="row">
                ...
                <th class="" style="width:70px;">Event ID</th>
