...
<div class="epl_cart_wrapper">
    ...
    <?php if ( !epl_is_free_event() && $mode != 'overview' && epl_get_setting( 'epl_registration_options', '_epl_display_discount_input_field', 10 ) == 10 ): ?>
        ...
        <div id="epl_discount_wrapper" class="epl_section epl_ov_a epl_ta_r">
            ...
            echo epl_get_setting( 'epl_registration_options', '_epl_discount_input_label', epl__( 'Discount Code' ) ) . "&nbsp;" . $cart_data['discount_field'];
            ?>
