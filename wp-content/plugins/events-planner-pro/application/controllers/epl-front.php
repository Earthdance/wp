...
//POST has higher priority
        ...
        function add_waitlist_record() {
            ...
            $this->erm->refresh_data();

            $r = epl__( "Your name has been added to the waitlist.  You will receive an emails shortly and will be notified when any spaces open up." );
...
//exit($i);
        ...
        function _moneris_process() {
            ...
            /* if ($this->egm->_moneris_response() === true){
              //$this->thank_you_page();
              }   else $this->show_cart_overview(); */
        ...
        function load_cart_in_modal( $m = 1 ) {
            ...
            $data['modal_cart_content'] = "<div class='epl_event_title'><h2>{$event_details['post_title']}</h2></div>";
            ...
            $data['money_totals'] = $_totals[$event_id]['money_totals'];
...
//add_filter( 'posts_clauses', array( $this, '_intercept_query_clauses' ), 20, 1 );
        ...
        function check_for_waitlist() {
            ...
            if ( epl_is_waitlist_record() && !epl_is_waitlist_session_approved() ) {
                ...
                $_SESSION['__epl']['waitlist_approved'] = 1;
        ...
        function show_cart() {
            ...
            if ( $wl_check !== true ) {
                return $this->epl_util->epl_invoke_error( 20, $wl_check, false );
            }
...
//will be refactored
        ...
        function _setup_payment_type( $gateway_info ) {
            ...
            if ( $this->pay_type == '_moneris' )
                add_filter( 'epl_cc_billing_fields', array( $this->egm, 'moneris_billing_fields' ) );
