    ...
    class EPL_Registration_Manager extends EPL_Controller {
        ...
        function save_postdata( $post_ID ) {
            ...
            /* $wpdb->query( "DELETE FROM $wpdb->postmeta
              ...
              " AND (`meta_key` like '_total_att_%' OR `meta_key` like '_total_waitlist_att_%') " ); */
        ...
        function send_email() {
            ...
            foreach ( $to_emails as $regis_post_id ) {
        ...
        function get_waitlist_info() {
            ...
            if ( !empty( $this->regis_meta['_epl_waitlist_status'] ) && $this->regis_meta['_epl_waitlist_status'] == 10 )
