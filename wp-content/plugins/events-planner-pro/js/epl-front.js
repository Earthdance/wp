...
jQuery(document).ready(function($){
    ...
    $(document.body).on('click','#epl_waitlist_form_submit', function(){
    ...
    $('body').on('change', '.epl_att_qty_dd, .epl_time_dd, .epl_cart_dates input,.epl_cart_dates_body input,  #epl_discount_wrapper input, #epl_donation_wrapper input,#epl_cart_totals_table input', function(){
